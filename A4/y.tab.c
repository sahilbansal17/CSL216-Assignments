...
{
  "$end", "error", "$undefined", "COMMAND", "EQUALS", "SEMICOLON", "NUM",
  "'\\n'", "' '", "$accept", "program", "statement", "commands", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    10,    32
};
# endif
